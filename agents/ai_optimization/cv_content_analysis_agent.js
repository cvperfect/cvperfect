/**
 * cv content analysis Agent
 * Role: Deep CV Content Analysis with OpenAI
 * Category: ai_optimization
 * Generated by CVPerfect Agent Factory
 */

class CvContentAnalysisAgent {
    constructor() {
        this.name = "cv_content_analysis";
        this.role = "Deep CV Content Analysis with OpenAI";
...
module.exports = CvContentAnalysisAgent;
