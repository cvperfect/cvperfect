/**
 * seo content Agent
 * Role: SEO Optimization & Content Strategy
...
class SeoContentAgent {
    constructor() {
        this.name = "seo_content";
        this.role = "SEO Optimization & Content Strategy";
        this.category = "content_localization";
        this.tools = [
        "semrush",
...
module.exports = SeoContentAgent;
