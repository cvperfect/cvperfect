...
const CVAnalysisDashboard = ({ optimizedCV, onPayment }) => {
  ...
  const analysisData = {
    ...
    sections: {
      summary: { status: 'good', recommendation: 'Dodaj więcej słów kluczowych' },
      experience: { status: 'warning', recommendation: 'Zmień nazwy sekcji na "Doświadczenie zawodowe"' },
      skills: { status: 'critical', recommendation: 'Brakuje 5 kluczowych umiejętności' },
      education: { status: 'good', recommendation: 'Sekcja kompletna' }
    }
  };
    ...
    <div className="max-w-6xl mx-auto p-6 bg-white">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600">
          Sprawdź jak AI poprawiło dopasowanie do oferty <span className="font-semibold">Software Developer</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
              ...
              <div className="text-sm text-yellow-600">Problemów do naprawy</div>
            </div>
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <div className="text-2xl font-bold text-green-700">+21%</div>
              <div className="text-sm text-green-600">Wzrost dopasowania</div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-2xl p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-4">🔍 Analiza słów kluczowych (30%)</h3>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-6 text-center relative h-full flex flex-col">
            ...
            <div className="text-3xl font-bold text-gray-700 mb-2">9,99 zł</div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-4 border-blue-400 rounded-xl p-6 text-center relative h-full flex flex-col transform lg:scale-110 shadow-2xl z-10">
            ...
            <ul className="text-left space-y-3 mb-6 flex-grow">
              ...
              <li className="flex items-center">
                <span className="text-green-500 mr-2 font-bold">✓</span>
                <span className="text-gray-900 font-bold">Wszystkie funkcje Basic</span>
              </li>
            </ul>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-4 border-purple-400 rounded-xl p-6 text-center relative h-full flex flex-col shadow-xl">
            ...
            <ul className="text-left space-y-3 mb-6 flex-grow">
              ...
              <li className="flex items-center">
                <span className="text-green-500 mr-2 font-bold">✓</span>
                <span className="text-gray-900 font-bold">Porównanie z konkurencją</span>
              </li>
              <li className="flex items-center">
                <span className="text-green-500 mr-2 font-bold">✓</span>
              ...
              <li className="flex items-center">
                <span className="text-green-500 mr-2 font-bold">✓</span>
                <span className="text-gray-900 font-bold">Wszystkie funkcje Pro</span>
              </li>
            </ul>
        ...
        <div className="mt-8 text-center">
          <div className="flex justify-center items-center space-x-8 text-sm text-gray-500">
            ...
            <span>💯 Gwarancja zwrotu 30 dni</span>
