...
export function setSecureCORS(req, res) {
  ...
  if (allowedOrigins.includes(origin)) {
    ...
    // Log suspicious requests but DO NOT set any CORS headers
    console.log('🚫 CORS blocked origin:', origin || 'unknown')
    // SECURITY: Don't set Access-Control-Allow-Origin for blocked origins
    // This prevents null origin attacks
  }
