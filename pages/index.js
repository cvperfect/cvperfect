...
{/* NOWY MODAL - 2 KROKI */}
{showMainModal && (
  <div className="modal-overlay" onClick={closeModal} style={{zIndex: 55}}>
...
.floating-notifications{
  ...
  right: 20px;
  z-index: 45;    /* scroll indicator below navigation */
  pointer-events: none;
  max-width: 380px;
}
...
navigation { position: fixed; top:0; left:0; right:0; z-index: 50 !important; }
